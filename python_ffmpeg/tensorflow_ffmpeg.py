...
parser.add_argument('--in_filename',default= "rtsp://admin:samples123@192.168.35.119:554/Streaming/tracks/201?starttime=20200116t105450z&endtime=20200117t170000z", help='Input filename')
parser.add_argument('--out_filename', default="out.mp4", help='Output filename')
parser.add_argument(
    '--dream', action='store_true',default=True, help='Use DeepDream frame processing (requires tensorflow)')
