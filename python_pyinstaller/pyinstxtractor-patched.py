#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @File     : pyinstxtractor-patched.py
# @Author   : jade
        ...
        for entry in self.tocList:
            ...
            with open(entry.name, 'wb') as f:
                if entry.typeCmprsData == b's':
                    f.write(b"3\r\r\n")  # Hack: do this properly (https://github.com/google/pytype/blob/master/pytype/pyc/magic.py)
                    f.write(b'\0' * 4)  # Write timestamp
                    if self.pyver >= 33:
                        f.write(b'\0' * 4)  # Size parameter added in Python 3.3
                f.write(data)
